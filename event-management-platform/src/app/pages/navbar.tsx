    ...
    <div className="flex justify-between items-center w-full h-20 px-4 text-white bg-blue-900">
      ...
      <div>
        <form className="flex items-center">
          ...
          <button
            type="submit"
            className="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-blue-700 border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 rounded-full"
          >
            <svg
              aria-hidden="true"
